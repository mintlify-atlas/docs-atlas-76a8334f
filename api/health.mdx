...
sidebarTitle: "Health"
description: "The GET /api/health endpoint pings all Sentinel dependencies — Prometheus, Loki, ChromaDB, Alertmanager, LangFuse, and Supabase — and returns an aggregate health status."
---
...
Full integration health check. Pings all six service dependencies in parallel, measures latency, and returns an aggregate status. Use this endpoint for dashboards, alerting, and diagnosing connectivity issues.
