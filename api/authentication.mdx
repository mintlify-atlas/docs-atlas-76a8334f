...
description: "Obtain a Supabase JWT and send it as a Bearer token on protected requests. Covers HS256 and ES256 validation, JWT payload fields, and the webhook secret."
---
