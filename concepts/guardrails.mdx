...
description: "How Sentinel's guardrail layer blocks prompt injection, enforces command whitelists, validates incident types, and keeps agent output scoped to DevOps."
---
