...
description: "How to view, filter, create, and export incidents in Sentinel. Covers incident cards, detail view, agent reasoning, metrics panel, timeline, runbooks, and similar incident matching."
---
