...
description: "Tour of the Sentinel React dashboard — live incident feed, agent reasoning panel, metrics, timelines, command palette, and export capabilities powered by Supabase Realtime."
---
...
<CardGroup cols={2}>
  ...
  <Card title="ApprovalBanner" icon="circle-check">
    Appears at the top of the detail pane when `status === 'awaiting_approval'`. Displays the proposed shell command in a monospace block and provides three action buttons: **Approve & Execute**, **Reject**, and **Postpone 30 min**.
  </Card>
