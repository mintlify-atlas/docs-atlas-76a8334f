...
sidebarTitle: "Docker"
description: "How Sentinel's DockerAgent investigates Docker container incidents using docker_inspect, docker_logs, docker_stats, and docker_ps — with automatic restart proposals."
---
