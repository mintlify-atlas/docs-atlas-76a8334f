...
sidebarTitle: "Podman"
description: "Configure Sentinel to monitor and triage Podman rootless containers using the Docker-compatible SDK via the Podman socket, without requiring the podman binary."
---
