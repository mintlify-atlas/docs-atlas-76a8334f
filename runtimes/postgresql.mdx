...
description: "PostgresAgent diagnoses database incidents via four pg_stat tools and proposes pg_terminate_backend, pg_cancel_backend, or pg_stat_activity for approval."
---
